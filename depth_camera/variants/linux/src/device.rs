...
impl CaptureFormat {
    ...
    pub const SUPPORTED_FOURCCS: &'static str = "Z16";
...
mod tests {
    ...
    fn topic_encoding_strings() {
        assert_eq!(CaptureFormat::Z16.topic_encoding(), "z16");
    }
    ...
    fn open_validated_rejects_regular_file() {
        let tmp = std::env::temp_dir().join("depth_camera_open_validated_test");
