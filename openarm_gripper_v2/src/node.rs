// Node composition: parses every parameter up front, takes the instance lock,
// brings up the CAN motor, then wires the state, health, command, and follow
// tasks. All device and stream logic lives in the sibling modules; this is
// only the assembly.
