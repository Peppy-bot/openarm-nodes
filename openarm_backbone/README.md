...
|---|---|---|
| `move_arm_joints` | `arm_id`, 7 joint positions (rad), `duration_s` (the limb_motion contract) | wrong joint count, non-finite, negative duration, out of joint limits, side busy |
