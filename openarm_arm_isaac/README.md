...
Drives one side of the OpenArm V10 (7 joints) inside Isaac Sim. It conforms to `openarm_arm:v1`, the same interface the real arm driver implements, so backbone and the UI work with it unchanged.
