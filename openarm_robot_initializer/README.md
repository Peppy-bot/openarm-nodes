...
Normally you won't run it by hand; the launchers in [launchers_hub/openarm](https://github.com/Peppy-bot/launchers_hub/tree/main/openarm) start it together with the rest of the stack. The [top-level README](../README.md) walks through the whole sequence:
